            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="descricao" class="form-control" placeholder="Digite uma Descricação ." >
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input  type=number step=0.01 name="preco" class="form-control" placeholder="R$ 1.200 ." >
