...
class PostsController extends Controller {
    ...
    public function index() {
        if (Gate::allows('View_post')) {
            ...
            return Redirect::back()->withErrors(['Não Possui Autorização, Para acessar as Postagens !', '']);
        }
    }
    ...
    public function cadastrar() {
        if (Gate::allows('Insert_post')) {
            ...
            return Redirect::back()->withErrors(['Não Possui Autorização, Para Cadastrar uma nova Postagem!', '']);
        }
    }
